...
def main(experiment, gpu):
    ...
    run_baseline_segmentation(
        experiment='./experiments/segmentation/baseline/config_ACDC_2_eval.yml', eval=True
    )
    run_baseline_segmentation(
        experiment='./experiments/segmentation/baseline/config_ACDC_4_eval.yml', eval=True
    )
    run_baseline_segmentation(
        experiment='./experiments/segmentation/baseline/config_ACDC_8_eval.yml', eval=True
    )
    run_baseline_segmentation(experiment='./experiments/segmentation/baseline/config_ACDC_UB.yml', eval=True)

    # pre-trained contrastive
    run_pre_trained_contrastive_segmentation(
        experiment='./experiments/segmentation/pre_trained_contrastive/config_ACDC_2_eval.yml', eval=True
    )
    run_pre_trained_contrastive_segmentation(
        experiment='./experiments/segmentation/pre_trained_contrastive/config_ACDC_4_eval.yml', eval=True
    )
    run_pre_trained_contrastive_segmentation(
        experiment='./experiments/segmentation/pre_trained_contrastive/config_ACDC_8_eval.yml', eval=True
    )

    # pre-trained rotation
    run_pre_trained_rotation_segmentation(
        experiment='./experiments/segmentation/pre_trained_rotation/config_ACDC_2_eval.yml', eval=True
    )
    run_pre_trained_rotation_segmentation(
        experiment='./experiments/segmentation/pre_trained_rotation/config_ACDC_4_eval.yml', eval=True
    )
    run_pre_trained_rotation_segmentation(
        experiment='./experiments/segmentation/pre_trained_rotation/config_ACDC_8_eval.yml', eval=True
    )

    # pre-trained patch
    run_pre_trained_patch_segmentation(
        experiment='./experiments/segmentation/pre_trained_patch/config_ACDC_2_eval.yml', eval=True
    )
    run_pre_trained_patch_segmentation(
        experiment='./experiments/segmentation/pre_trained_patch/config_ACDC_4_eval.yml', eval=True
    )
    run_pre_trained_patch_segmentation(
        experiment='./experiments/segmentation/pre_trained_patch/config_ACDC_8_eval.yml', eval=True
    )
    ...
    run_baseline_classification(
        experiment='./experiments/classification/baseline/config_HIST_2_eval.yml', eval=True
    )
    run_baseline_classification(
        experiment='./experiments/classification/baseline/config_HIST_4_eval.yml', eval=True
    )
    run_baseline_classification(
        experiment='./experiments/classification/baseline/config_HIST_8_eval.yml', eval=True
    )
    run_baseline_classification(
        experiment='./experiments/classification/baseline/config_HIST_UB.yml', eval=True
    )

    # pre-trained contrastive (SimCLR, eval=True)
    run_pre_trained_classification(
        experiment='./experiments/classification/pre_trained/config_HIST_2_eval_contrastive.yml', eval=True
    )
    run_pre_trained_classification(
        experiment='./experiments/classification/pre_trained/config_HIST_4_eval_contrastive.yml', eval=True
    )
    run_pre_trained_classification(
        experiment='./experiments/classification/pre_trained/config_HIST_8_eval_contrastive.yml', eval=True
    )

    # pre-trained rotation
    run_pre_trained_classification(
        experiment='./experiments/classification/pre_trained/config_HIST_2_eval_rotation.yml', eval=True
    )
    run_pre_trained_classification(
        experiment='./experiments/classification/pre_trained/config_HIST_4_eval_rotation.yml', eval=True
    )
    run_pre_trained_classification(
        experiment='./experiments/classification/pre_trained/config_HIST_8_eval_rotation.yml', eval=True
    )

    # pre-trained patch (CP, eval=True)
    run_pre_trained_classification(
        experiment='./experiments/classification/pre_trained/config_HIST_2_eval_patch.yml', eval=True
    )
    run_pre_trained_classification(
        experiment='./experiments/classification/pre_trained/config_HIST_4_eval_patch.yml', eval=True
    )
    run_pre_trained_classification(
        experiment='./experiments/classification/pre_trained/config_HIST_8_eval_patch.yml', eval=True
    )
    ...
    run_baseline_regression(
        experiment='./experiments/regression/baseline/config_aptos_2_eval.yml', eval=True
    )
    run_baseline_regression(
        experiment='./experiments/regression/baseline/config_aptos_4_eval.yml', eval=True
    )
    run_baseline_regression(
        experiment='./experiments/regression/baseline/config_aptos_8_eval.yml', eval=True
    )
    run_baseline_regression(experiment='./experiments/regression/baseline/config_aptos_UB.yml', eval=True)

    # pre-trained contrastive (SimCLR, eval=True)
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_2_eval_contrastive.yml', eval=True
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_4_eval_contrastive.yml', eval=True
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_8_eval_contrastive.yml', eval=True
    )

    # pre-trained rotation
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_2_eval_rotation.yml', eval=True
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_4_eval_rotation.yml', eval=True
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_8_eval_rotation.yml', eval=True
    )

    # pre-trained patch (CP, eval=True)
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_2_eval_patch.yml', eval=True
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_4_eval_patch.yml', eval=True
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_8_eval_patch.yml', eval=True
    )
