...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=".",
        help='Exports "scores.txt" to given output directory for codalab' 'Defaults to %(default)s',
    )
    ...
    for seq in test_sequences:
        ...
        gt_file_list = [
            f for f in os.listdir(os.path.join(args.dataset, seq_dir_gt)) if f.endswith(".label")
        ]
