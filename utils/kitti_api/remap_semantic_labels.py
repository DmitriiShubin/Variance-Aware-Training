...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help='Map from xentropy to original, instead of original to xentropy. ' 'Defaults to %(default)s',
    )
    ...
    for sequence in sequence:
        ...
        label_paths = os.path.join(root_directory, "sequences", sequence, label_directory)
