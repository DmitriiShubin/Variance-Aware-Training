...
import kardioml.segmentation.teijeiro.utils.signal_processing.Douglas_Peucker as DP
import kardioml.segmentation.teijeiro.knowledge.constants as C
from kardioml.segmentation.teijeiro.utils.signal_processing.wave_extraction import extract_waves, Wave
from kardioml.segmentation.teijeiro.utils.units_helper import (
    msec2samples as ms2sp,
    phys2digital as ph2dg,
    digital2mm as dg2mm,
    samples2mm as sp2mm,
)
from kardioml.segmentation.teijeiro.knowledge.abstraction_patterns.segmentation import characterize_baseline
from kardioml.segmentation.teijeiro.utils.signal_processing.signal_measures import get_peaks
from kardioml.segmentation.teijeiro.utils.signal_processing.dtw import dtw_std
from kardioml.segmentation.teijeiro.utils.signal_processing.xcorr_similarity import xcorr_full, signal_match
from kardioml.segmentation.teijeiro.model import Interval as Iv
from kardioml.segmentation.teijeiro.model.constraint_network import verify, InconsistencyError
from kardioml.segmentation.teijeiro.model.automata import PatternAutomata, ABSTRACTED
import operator
import numpy as np
import math
...
QRS_SHAPES = {
    'Q': set(('rS', 'rs', 'rSr', 'rsr', 'Q', 'QS', 'Qs', 'Qr', 'qr')),
    'QR': set(('qRs', 'QRs', 'R', 'RS', 'Rs', 'rsR', 'Rr', 'QR', 'qR', 'Qr', 'qr', 'RSR', 'rSr', 'RsR')),
    ...
    'RR': set(('qRs', 'rsR', 'RrS', 'RsR', 'rsr', 'Rr', 'RR', 'R', 'rR', 'rr', 'qR', 'Rs')),
    'RS': set(
        (
            'Rs',
            'RS',
    ...
    'RSR': set(('RSR', 'rsR', 'Rs', 'RsR', 'RS', 'RrS', 'R', 'Rr', 'rR', 'RR', 'RS')),
    'Rr': set(('Rr', 'Rs', 'qRs', 'QRs', 'qR', 'QR', 'RR', 'rR', 'rr', 'R', 'r', 'rsR')),
    'RrS': set(('RrS', 'rS', 'RsR', 'RSR', 'RS')),
    'Rs': set(('Rs', 'qRs', 'rs', 'r', 'qR', 'R', 'QRs', 'rsr', 'RS', 'RsR', 'rS', 'QR', 'RR', 'Rr', 'rR')),
    'RsR': set(('RsR', 'Rs', 'rsR', 'RSR', 'rsr', 'RS', 'rSr', 'RR')),
    'qR': set(('qR', 'qRs', 'qr', 'rsR', 'QRs', 'QR', 'R', 'r', 'Qr', 'Rs', 'RS')),
    'qRs': set(('qRs', 'RS', 'Rs', 'rs', 'r', 'qr', 'qR', 'R', 'QRs', 'QR', 'Qr', 'Rr', 'rsR')),
    'qS': set(('qS', 'Q', 'rS', 'QS', 'rsr', 'Qs', 'rSr', 'QrS')),
    'qr': set(('qr', 'qRs', 'r', 'Rs', 'qR', 'rsR', 'QRs', 'R', 'QR', 'rr', 'QR', 'Rr', 'rr', 'rsr')),
    'r': set(('r', 'qRs', 'Rs', 'rs', 'qr', 'rsR', 'qR', 'R', 'Rr', 'QRs', 'rsr', 'QR', 'rR', 'rr', 'Qr')),
    'rR': set(
        ('qRs', 'QRs', 'Rs', 'RS', 'r', 'qR', 'qR', 'R', 'rsR', 'RsR', 'Rr', 'QR', 'RR', 'rr', 'rR', 'rsr')
    ),
    'rS': set(('Rs', 'rs', 'Q', 'rS', 'QS', 'rsr', 'Qs', 'rSr', 'RS', 'QrS', 'qS', 'Qs', 'Qr')),
    'rSr': set(('rSr', 'Q', 'QS', 'rsr', 'RsR', 'RSR', 'RS', 'rS', 'qS', 'QrS')),
    'rr': set(('rr', 'Rs', 'r', 'qr', 'qR', 'RrS', 'Rr', 'RR', 'rR')),
    'rs': set(('rs', 'rS', 'Rs', 'QS', 'rsr', 'rSr', 'RS', 'rSr', 'Qs', 'r', 'Q', 'R', 'QRs', 'qRs', 'rsR')),
    'rsR': set(
        ('rsR', 'qRs', 'Rs', 'qR', 'QR', 'Rr', 'rR', 'RR', 'R', 'r', 'QRs', 'rsr', 'RsR', 'rSr', 'RSR')
    ),
...
def _reference_wave(shape):
    ...
    if idx == -1:
        ...
        if shape.tag in (
            ...
            return 0
        elif shape.tag in ('qRs', 'QRs', 'QRS', 'rS', 'rSr', 'rR', 'qR', 'QR', 'qr', 'Qs', 'qS'):
            return 1
