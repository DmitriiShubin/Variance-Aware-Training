...
import cv2
from models.YoloV4.pytorch_YOLOv4.tool.darknet2pytorch import Darknet
import argparse
from models.YoloV4.pytorch_YOLOv4.tool.utils import *
from models.YoloV4.pytorch_YOLOv4.tool.torch_utils import *
...
def arg_parse():
    ...
    parser.add_argument(
        "--confidence", dest="confidence", help="Object Confidence to filter predictions", default=0.25
    )
