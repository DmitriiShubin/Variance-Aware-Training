...
def main(experiment, gpu):
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_2_contrastive.yml', gpu='6,7'
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_2_patch.yml', gpu='6,7'
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_2_rotation.yml', gpu='6,7'
    )

    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_2_1_contrastive.yml', gpu='6,7'
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_2_1_patch.yml', gpu='6,7'
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_2_1_rotation.yml', gpu='6,7'
    )

    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_4_contrastive.yml', gpu='6,7'
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_4_patch.yml', gpu='6,7'
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_4_rotation.yml', gpu='6,7'
    )

    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_4_1_contrastive.yml', gpu='6,7'
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_4_1_patch.yml', gpu='6,7'
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_4_1_rotation.yml', gpu='6,7'
    )

    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_8_contrastive.yml', gpu='6,7'
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_8_patch.yml', gpu='6,7'
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_8_rotation.yml', gpu='6,7'
    )

    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_8_1_contrastive.yml', gpu='6,7'
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_8_1_patch.yml', gpu='6,7'
    )
    run_pre_trained_regression(
        experiment='./experiments/regression/pre_trained/config_aptos_8_1_rotation.yml', gpu='6,7'
    )
