...
from experiments.classification.adversarial_network_train_val_late.run_experiment import (
    run as run_efficientnet_adv_late_classification,
)
...
def main(experiment, gpu):
    ...
    #HIST
    #run_efficientnet_baseline_classification(experiment='./experiments/classification/baseline/config_RANZCR_8.yml', gpu='0,1')
    ...
    run_efficientnet_adv_late_classification(
        experiment=f'./experiments/classification/adversarial_network_train_val_late/config_HIST_2.yml', gpu='6,7')
    run_efficientnet_adv_late_classification(
        experiment=f'./experiments/classification/adversarial_network_train_val_late/config_HIST_4.yml', gpu='6,7')
    run_efficientnet_adv_late_classification(
        experiment=f'./experiments/classification/adversarial_network_train_val_late/config_HIST_8.yml', gpu='6,7')
