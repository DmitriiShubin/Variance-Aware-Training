...
def main(experiment, gpu):
    ...
    run_efficientnet_adv_late_classification(
        experiment=f'./experiments/classification/adversarial_network_train_val_late/config_HIST_2.yml',
        gpu='6,7',
    )
    run_efficientnet_adv_late_classification(
        experiment=f'./experiments/classification/adversarial_network_train_val_late/config_HIST_4.yml',
        gpu='6,7',
    )
    run_efficientnet_adv_late_classification(
        experiment=f'./experiments/classification/adversarial_network_train_val_late/config_HIST_8.yml',
        gpu='6,7',
    )
